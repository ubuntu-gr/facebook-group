...
* 7) Δεν επιτρέπεται η δημοσίευση εντολών ή οι συζητήσεις που αφορούν την παραβίαση συστημάτων σε οποιαδήποτε μορφή (ασύρματα δίκτυα, βάσεις δεδομένων...κλπ), χωρίς την αποδεδειγμένη άδεια του ιδιοκτήτη τους.
